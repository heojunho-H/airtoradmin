// Cloudflare Pages Function — /api/labor_rates 프록시
// 프론트엔드 → 같은 도메인(/api/labor_rates) → Cafe24 서버로 전달 (CORS 우회)

const TARGET = 'https://airtor.co.kr/api/labor_rates_api.php';
